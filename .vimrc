" Put this at your home directory and create two folders, .vim_bundle and .vim_undodir. Then git clone Vundle.vim into the .vim_bundle directory (thus, having .vim_bundle/Vundle.vim). Then, run :PluginInstall. - Erik S. V. Jansson
